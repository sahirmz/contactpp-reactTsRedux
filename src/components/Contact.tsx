...
const Contact = () => {
  ...
  const renderNoContactAvailable = () => {
    return (
      <div className="bg-[#F3F3F3] p-5 flex flex-col items-center md:h-screen md:w-full justify-center text-[#f3f5f6]">
        <button
          type="button"
          className="font-bold md:text-2xl text-1xl bg-[#2b1146] px-[20px] py-[15px] rounded-[15px] hover:bg-[#4c51f4] hover:text-white"
          onClick={() => dispatchFn(changeCreateContactStatus())}
        >
          Create Contact
        </button>

        <div className="bg-[#2b1146] flex items-center border border-grey shadow p-5 rounded-lg mt-10 text-[#f3f5f6]">
  ...
  const contactListItem = () => {
    return (
      <div className="bg-[#F3F3F3] flex  flex-col md:h-screen md:w-full items-center">
        ...
        <button
          type="button"
          className="fixed bottom-[20px] font-bold md:text-2xl text-1xl text-white bg-[#2b1146] px-[20px] py-[15px] rounded-[15px] hover:bg-[#4c51f4] hover:text-[#f3f5f6]"
          onClick={() => dispatchFn(changeCreateContactStatus())}
        >
          Create Contact
        </button>
